...
public class SelectSeat40 extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        d6 = findViewById(R.id.Btn_d6);
        d7 = findViewById(R.id.Btn_d7);
        d8 = findViewById(R.id.Btn_d8);
        d9 = findViewById(R.id.Btn_d9);
        d10 = findViewById(R.id.Btn_d10);
    }
    ...
    public void checkCheckBox(View v){
        ...
        if (d6.isChecked()) selectedOrNot(1);
        if (d7.isChecked()) selectedOrNot(1);
        if (d8.isChecked()) selectedOrNot(1);
        if (d9.isChecked()) selectedOrNot(1);
        if (d10.isChecked()) selectedOrNot(1);
    ...
    public void onBackPressed() {
        super.onBackPressed();
        startActivity(new Intent(SelectSeat40.this, ViewBuses.class));
        finish();
    }
}